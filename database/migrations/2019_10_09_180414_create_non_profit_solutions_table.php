...
class CreateNonProfitSolutionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('non_profit_solutions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('non_profit_solutions');
    }
}
