  ...
  <header class="mobile-nav" role="banner">
    ...
    <nav class="drawer-nav" role="navigation">
      ...
      <ul class="drawer-menu">
        <li class="{{ (request()->is('/')) ? 'business-solutions' : 'drawer-menu-active' }}{{ (request()->is('business-solutions')) ? 'drawer-menu-active' : '' }}"><a class="drawer-menu-item" href="business-solutions" >Business Solutions</a></li>
